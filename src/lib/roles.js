...
export const ROLE_ROUTES = {
  owner: new Set(['dashboard', 'branches', 'menu', 'tables', 'reservations', 'staff', 'orders', 'reports', 'order-taking', 'billing', 'payment-methods', 'settings', 'invoices', 'expenses', 'profile', 'activity-logs', 'tax-settings']),
  admin: new Set(['dashboard', 'branches', 'menu', 'tables', 'reservations', 'staff', 'orders', 'reports', 'order-taking', 'billing', 'payment-methods', 'settings', 'invoices', 'expenses', 'profile', 'activity-logs', 'tax-settings']),
  manager: new Set(['dashboard', 'menu', 'tables', 'reservations', 'staff', 'orders', 'reports', 'order-taking', 'billing', 'payment-methods', 'expenses', 'profile']),
...
export const canManageStaff = (role) => role === ROLES.OWNER || role === ROLES.ADMIN || role === ROLES.MANAGER
export const isManagerOnly = (role) => role === ROLES.MANAGER
export const canManageExpenses = (role) => role === ROLES.OWNER || role === ROLES.ADMIN || role === ROLES.MANAGER
export const canViewInvoices = (role) => role === ROLES.OWNER || role === ROLES.ADMIN
export const canViewActivityLogs = (role) => role === ROLES.OWNER || role === ROLES.ADMIN
export const canManageTaxes = (role) => role === ROLES.OWNER || role === ROLES.ADMIN
