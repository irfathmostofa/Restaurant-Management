    ...
    <div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <form
          ...
          className="lg:col-span-2 bg-white rounded-xl border border-stone-200 p-6 space-y-4"
        >
          ...
          <div>
            ...
            <input
              ...
              disabled
              className="w-full px-3 py-2 rounded-lg border border-stone-300 text-sm bg-stone-100 text-stone-500"
            />
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl border border-stone-200 p-6">
            ...
            <dl className="space-y-3 text-sm">
              ...
              <div>
                ...
                <dd>
                  <span
                    className={`text-xs font-medium rounded-full px-2.5 py-0.5 ${staff.active ? "bg-emerald-100 text-emerald-700" : "bg-stone-100 text-stone-500"}`}
                  >
              ...
              <div>
                ...
                <dd className="text-stone-800">
                  {staff.last_login_at
                    ? fmtDateTime(staff.last_login_at)
                    : "Never"}
                </dd>
              </div>
            </dl>
          ...
          >
            ...
            {pwMsg && (
              <p className="text-sm text-emerald-600 font-medium">{pwMsg}</p>
            )}
            <button
              type="submit"
              disabled={pwSaving}
              className="w-full px-5 py-2 rounded-lg bg-brand-600 text-white text-sm font-medium hover:bg-brand-700 disabled:opacity-60"
            >
